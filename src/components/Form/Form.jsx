...
export const Form = ({ dataPhonebook, onSubmit, onChange }) => {
    return (
      ...
      <label htmlFor='nameContact'>Name</label> 
        <input className={css.input} id="nameContact" type="text" name="name" value={ dataPhonebook.value} onChange={onChange} pattern="[A-Za-z]{1,32}" required placeholder="Name"></input>
